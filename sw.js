...
const cacheName = 'chtbt2-81595ea1'; // Updated hash to force the new SW to install
...
const filesToCache = [
    ...
    './js/ui/SurgicalEditManager.js',
    './js/ui/TextRenderer.js',
    './js/ui/ToolsManager.js',
    './js/ui/UIManager.js',
    './js/utils/CompressionUtils.js',
